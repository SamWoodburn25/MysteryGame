...
public class CharacterSelectScreen extends Screen {
    ...
    public CharacterSelectScreen(PlayLevelScreen playLevelScreen) {
        this.playLevelScreen = playLevelScreen;
        background = ImageLoader.load("ContextScreen0.png");

        getChar = new SpriteFont("Select Your Character", 200, 123, "Apple Chancery", 30, new Color(184, 15, 10));
        ...
        char2 = new SpriteFont("Short", 250, 323, "Apple Chancery", 30, new Color(184, 15, 10));
    ...
    public void update() {
        ...
        if (!keyLocker.isKeyLocked(Key.SPACE) && Keyboard.isKeyDown(Key.SPACE)) {
            ...
            if (menuItemSelected == 0) {
                ...
                playLevelScreen.startGame(true);
            } else if (menuItemSelected == 1) {
                character = false;
                System.out.println("short");
                playLevelScreen.startGame(false);
            }
        }
    }
