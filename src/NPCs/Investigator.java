...
// This class is for the investigator NPC
public class Investigator extends NPC {

    public Investigator(int id, Point location) {
        super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("investigator.png"), 50, 90), "BOUNCE_RIGHT");
    }
