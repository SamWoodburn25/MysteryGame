...
public class ScooterGirl extends NPC {

    public ScooterGirl(int id, Point location) {
        super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("randomGirl.png"), 40, 70), "BOUNCE_RIGHT");
    }
